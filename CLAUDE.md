...
tests/unit/             # 1021 unit tests — all mocked, no API keys needed
...
All 1021 unit tests must pass. Never modify a test to make it pass — fix the code.
...
- [ ] `make test` passes (all 1021 tests)
- [ ] `make lint` passes
