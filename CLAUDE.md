...
tests/unit/             # 927 unit tests — all mocked, no API keys needed
...
All 927 unit tests must pass. Never modify a test to make it pass — fix the code.
...
- [ ] `make test` passes (all 927 tests)
- [ ] `make lint` passes
