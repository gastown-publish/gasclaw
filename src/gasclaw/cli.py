...
from gasclaw.migration import migrate, rollback, MigrationError
...
def migrate_cmd(
    backup_dir: Path = typer.Option(
        None,
        "--backup-dir",
        help="Directory to store backup (default: ~/.gasclaw/backups)",
    ),
    ...
    force: bool = typer.Option(
        False,
        "--force",
        help="Proceed even if no Gastown installation is detected",
    ),
) -> None:
